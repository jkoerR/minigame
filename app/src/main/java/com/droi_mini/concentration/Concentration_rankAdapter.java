...
//
//public class Concentration_rankAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
//
...
//
//    public Concentration_rankAdapter(Context context, ArrayList<DTO_WM_Award> arrayList, View.OnClickListener clickListener) {
